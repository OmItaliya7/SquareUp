      ...
      <div className="flex flex-col px-6 pb-10 xl:px-10 xl:pb-20 2xl:px-12.5 2xl:pb-25 gap-5 xl:gap-6 2xl:gap-7.5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-2.5 tracking-[.6%] ">
            ...
            <span className="inline-block px-2.5 py-2 xl:px-3 2xl:px-3.5 2xl:py-2.5 rounded-lg bg-[#262626] border border-[#262626] text-[#98989A] text-sm xl:text-base 2xl:text-xl  font-normal">
              {url}
            </span>
          </div>
    
          <a href={url} target="_blank" rel="noopener noreferrer" aria-label={`Visit ${brand} website`} >
            <img src={squareIcon} alt={`Visit ${brand} website`} className="size-11.5 2xl:size-13.5"  loading="lazy"/>
          </a>
        </div>
