  ...
  // export default IntroBlock;
    ...
    const IntroBlock = ({ title, description, label }) => (
      <div className="flex flex-col gap-7.5 xl:gap-10 2xl:gap-12.5 px-4 py-10 xl:p-10 xl:pt-20 2xl:p-12.5 2xl:pt-30 border-b border-border-subtle">
        ...
        <div className="flex flex-col gap-2.5">
            <h2 className="text-[28px] xl:text-[38px] 2xl:text-[48px] font-semibold leading-[1.2] text-text-primary ">
              {title}
            </h2>
            <p className="text-text-secondary text-sm xl:text-base 2xl:text-lg tracking-[-.6%] max-w-237.5 2xl:max-w-300">
              {description}
            </p>
        </div>
        
        <p className="self-start inline-flex items-center p-2.5 2xl:px-3.5 2xl:py-2.75 rounded-lg bg-bg-secondary text-text-primary text-base xl:text-lg 2xl:text-[22px]">
          {label}
        </p>
