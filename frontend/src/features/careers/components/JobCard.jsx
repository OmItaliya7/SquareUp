  ...
  return (
    <div
      ...
      <a 
        ...
        className="block w-full rounded-lg bg-bg-secondary px-4 py-3.5 text-center text-sm font-medium leading-6 text-primary transition-colors hover:bg-bg-hover 2xl:py-4.5 2xl:text-lg">
        Apply Now
      </a>
